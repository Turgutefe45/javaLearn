...
public class C01_Arraylist {
    ...
    Collections ==> Bir araya getirilmis parcalar anlamına gelir. ArrayList, Set, Vector, Queue ler java collections sınıfı nesneleridir.
        ...
        ArrayList<Integer>liştSayı=new ArrayList<>();
        System.out.println("listSayı:"+liştSayı);
        liştSayı.add(10);
        System.out.println("listSayı:"+liştSayı);
        liştSayı.add(34);
        liştSayı.add(27);
        liştSayı.add(98);
        System.out.println("listSayı: "+liştSayı);
        ArrayList<String>listIsim=new ArrayList<>(Arrays.asList("Almanya","ingiltere"));*/
